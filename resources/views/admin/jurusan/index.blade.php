                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <form action="{{ route('admin.jurusan.destroy', $jurusan) }}" method="POST" data-confirm="Yakin ingin menghapus jurusan ini?" data-confirm-title="Hapus Jurusan" data-confirm-ok="Ya, Hapus">@csrf @method('DELETE')<button class="btn btn-ios btn-ios-sm btn-ios-danger"><i class="bi bi-trash"></i></button></form>
                            </div>
                        </td>
                    </tr>
                    @empty
