    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
                ...
                <div class="card-body" style="padding: 32px;">
                    ...
                    <div style="background: var(--bg-secondary); border-radius: 16px; padding: 24px; border: 2px dashed var(--border-color);">
                        <table style="width: 100%;">
                            ...
                            @endif
                            <tr>
                                <td colspan="2" style="padding: 12px 0 4px;"><hr style="border-color: var(--border-color); margin: 0;"></td>
                            </tr>
                            <tr>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.08); border: 1px solid rgba(245, 158, 11, 0.2); border-radius: 12px; padding: 12px 16px; margin-top: 20px; display: flex; align-items: flex-start; gap: 10px;">
                        ...
                        <div style="font-size: 12px; color: #92400e; font-weight: 500;">
                            <strong>Perhatian:</strong> Password ini hanya ditampilkan <strong>satu kali</strong>. Pastikan untuk menyimpan atau mencetak sebelum meninggalkan halaman ini. Jika lupa, Anda bisa melakukan reset password.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex gap-2 mt-3">
                ...
                <a href="{{ route('admin.users.create') }}" class="btn btn-ios btn-ios-success flex-grow-1">
                    <i class="bi bi-plus-lg"></i> Tambah Siswa Lain
                </a>
            </div>

            <div class="mt-2">
                <a href="{{ route('admin.users.index') }}" class="btn btn-ios btn-ios-light w-100">
